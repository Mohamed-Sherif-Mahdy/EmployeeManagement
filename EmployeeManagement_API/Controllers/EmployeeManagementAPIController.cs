...
namespace EmployeeManagement_API.Controllers
{
    ...
    public class EmployeeManagementAPIController : ControllerBase
    {
        ...
        public EmployeeManagementAPIController(
            IServiceEmployee employeeRepository,
            IServiceJob jobService
        )
        {
        ...
        public IActionResult GetEmployees()
        {
            ...
            List<EmployeeWithJobTitleDto> employeeWithJobTitleDtos =
                new List<EmployeeWithJobTitleDto>();
        ...
        public IActionResult PostEmployee(EmployeeWithJobTitleDto employeeWithJobTitleDto)
        {
            ...
            return CreatedAtAction(
                "GetEmployee",
                new { id = employeeWithJobTitleDto.EmployeeId },
                employeeWithJobTitleDto
            );
        }
